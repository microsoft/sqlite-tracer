...
The library assembly itself does not reference any particular SQLite bindings, so it can be used with any C# application that eventually includes the native SQLite library.
